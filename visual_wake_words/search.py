...
parser.add_argument('-d', '--dataset', default='coco2014_96_tf', type=str,
                    help='coco2014_96_tf')
...
def main():
    ...
    if args.visualization:
        ...
        wandb.define_metric('Search_Test/Acc', summary='last')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset == 'coco2014_96':
        ...
        n_val = int(n_samples * 0.1) # 10% of the dataset is used for validation

        train_set, val_set = torch.utils.data.random_split(dataset, [n_samples - n_val, n_val])
    ...
    elif args.dataset == 'coco2014_96_tf':
